...
import { AssignRoleGroupComponent } from './assign-rolegroup.component';
...
@NgModule({
  declarations: [AssignRoleGroupComponent],
  imports: [
    CommonModule,
    InputsModule,
    ButtonsModule,
  ...
  exports: [AssignRoleGroupComponent],
})
export class AssignRoleGroupModule {}
