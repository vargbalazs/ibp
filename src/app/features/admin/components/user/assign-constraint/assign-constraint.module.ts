...
import { AssignConstraintComponent } from './assign-constraint.component';
...
@NgModule({
  declarations: [AssignConstraintComponent],
  imports: [
    CommonModule,
    InputsModule,
    ButtonsModule,
  ...
  exports: [AssignConstraintComponent],
})
export class AssignConstraintModule {}
