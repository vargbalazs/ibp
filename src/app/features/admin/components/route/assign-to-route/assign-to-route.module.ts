...
import { AssignToRouteComponent } from './assign-to-route.component';
...
@NgModule({
  declarations: [AssignToRouteComponent],
  imports: [
    CommonModule,
    InputsModule,
    ButtonsModule,
  ...
  exports: [AssignToRouteComponent],
})
export class AssignToRouteModule {}
